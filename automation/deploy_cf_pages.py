...
SW_OLD_VERSION = "const CACHE_VERSION = 'tacobell-dashboard-v13';"
SW_NEW_VERSION = "const CACHE_VERSION = 'tacobell-dashboard-v14';  // v14: Cloudflare (elaxisti thermokrasia)"
